...
STATIC_ROOT = os.path.join(BASE_DIR, 'static')  # Folder where collected static files are stored
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'staticfiles'),  # This should be different from STATIC_ROOT
]
